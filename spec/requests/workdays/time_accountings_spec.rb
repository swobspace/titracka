...
RSpec.describe "/workdays/:id/time_accountings", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get workday_time_accountings_url(workday)
  ...
  describe "GET /show" do
    it "renders a successful response" do
      ...
      get workday_time_accounting_url(workday, time_accounting)
      expect(response).to be_successful
    end
  end
  ...
  describe "GET /new" do
    it "renders a successful response" do
      get new_workday_time_accounting_url(workday)
      expect(response).to be_successful
    end
  end
  ...
  describe "GET /edit" do
    it "render a successful response" do
      time_accounting = TimeAccounting.create! valid_attributes
      get edit_workday_time_accounting_url(workday, time_accounting)
      expect(response).to be_successful
    end
  end
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new TimeAccounting" do
        expect {
          post workday_time_accountings_url(workday), params: { time_accounting: post_attributes }
    ...
    context "with invalid parameters" do
      it "does not create a new TimeAccounting" do
        expect {
          post workday_time_accountings_url(workday), params: { time_accounting: invalid_attributes }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested time_accounting" do
        time_accounting = TimeAccounting.create! valid_attributes
        patch workday_time_accounting_url(workday, time_accounting), params: { time_accounting: new_attributes }
    ...
    context "with invalid parameters" do
      it "renders a successful response (i.e. to display the 'edit' template)" do
        time_accounting = TimeAccounting.create! valid_attributes
        patch workday_time_accounting_url(workday, time_accounting), params: { time_accounting: invalid_attributes }
        expect(response).to have_http_status(422)
      end
    end
  end
  ...
  describe "DELETE /destroy" do
    it "destroys the requested time_accounting" do
      time_accounting = TimeAccounting.create! valid_attributes
      expect {
        delete workday_time_accounting_url(workday, time_accounting)
      }.to change(TimeAccounting, :count).by(-1)
    end
