...
ActiveRecord::Schema[7.0].define(version: 2022_12_18_165246) do
  ...
  create_table "cross_references", charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
  ...
  create_table "day_types", charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
  ...
  create_table "lists", charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
  ...
  create_table "org_units", charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
    t.string "name", default: ""
    t.string "ancestry"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "reference_urls", charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
    t.bigint "reference_id", null: false
    t.string "name", default: ""
  ...
  create_table "references", charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
    t.string "name", default: ""
  ...
  create_table "sessions", charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
  ...
  create_table "states", charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
  ...
  create_table "time_accountings", charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
    t.bigint "task_id"
    t.bigint "user_id"
    t.string "description", default: ""
    t.date "date"
  ...
  create_table "wobauth_authorities", charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
  ...
  create_table "wobauth_groups", charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
    t.string "name"
  ...
  create_table "wobauth_memberships", charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "group_id"
  ...
  create_table "wobauth_roles", charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  end

  create_table "wobauth_users", charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
  ...
  create_table "workdays", charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.date "date"
    t.time "work_start"
